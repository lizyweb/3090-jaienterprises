document.addEventListener('DOMContentLoaded', () => {
  ...
  function bannerCarouselTwo() {
    ...
    $('.banner-carousel.banner-carousel-2').on('beforeChange', function(event, slick, currentSlide, nextSlide) {
        var $currentSlide = $(slick.$slides[currentSlide]);
        var $nextSlide = $(slick.$slides[nextSlide]);

        $currentSlide.removeClass('slide-in-left');
        $nextSlide.addClass('slide-in-left');
    });
}
bannerCarouselTwo();
